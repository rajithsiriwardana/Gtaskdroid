   ...
   private TimePickerDialog showTimePicker() {
    ...
    private void populateFields()  {
        ...
        if (mRowId != null) {
            ...
            mNoteText.setText(reminder.getString(
                    reminder.getColumnIndexOrThrow(RemindersDbAdapter.KEY_NOTE)));
    ...
    private void saveState() {
        ...
        if (mRowId == null) {
        	...
        	long id = mDbHelper.createReminder(title, note, reminderDateTime);
            if (id > 0) {
                mRowId = id;
            }
        } else {
            mDbHelper.updateReminder(mRowId, title, note, reminderDateTime);
        }
